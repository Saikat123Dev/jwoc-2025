      ...
      >
        ...
        >
          ...
          <p className="text-gray-300 text-lg">
            Thank you for your interest in becoming a mentor. Registration for the current period is now closed. Please check back later for future opportunities.
          </p>
        </motion.div>
      </motion.div>
    </div>
...
//       const response = await fetch('https://jwoc-2025-1.onrender.com/api/mentor/registerMentor', {
//         method: 'POST',
//         headers: {
