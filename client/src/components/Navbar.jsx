      ...
      <div className="min-w-full mx-auto">
        <div className="mt-2 p-4 flex items-center justify-between rounded-2xl shadow-xl relative">
          ...
          <div className="hidden md:flex flex-1 mx-8">
            <div className="backdrop-blur-lg bg-gradient-to-br from-white/20 to-white/10 dark:from-black/30 dark:to-black/20 rounded-3xl border border-white/30 shadow-lg shadow-black/10 px-8 py-4 min-w-full">
          ...
          {/* Mentor Locker Button */}
          <button className="hidden md:flex group items-center space-x-2 bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white px-6 py-3 rounded-xl text-lg font-semibold shadow-lg hover:shadow-xl transition-all duration-300">
