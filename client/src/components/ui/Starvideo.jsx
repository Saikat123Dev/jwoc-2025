  ...
  return (
    <div>
      ...
      >
        <div
          ref={initialTextRef}
          className="absolute top-1/3 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-50 text-center"
        >
          <h1 className="text-4xl sm:text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-pink-500 to-purple-600 font-rubik glow-text">
            JWoC - 2025
          </h1>
          ...
          <style jsx>
            {`
              @keyframes glow-text {
                ...
                50% {
                  text-shadow: 0 0 20px rgba(0, 255, 128, 0.8), 0 0 30px rgba(0, 128, 255, 0.6), 0 0 40px rgba(128, 0, 255, 0.8);
                }
                100% {
                  text-shadow: 0 0 10px rgba(0, 255, 128, 0.6), 0 0 20px rgba(128, 0, 255, 0.6);
                }
              }
          ...
          <p className="text-cyan-500 text-glow">season 6 In Association With</p>
          <h1 className="text-xl sm:text-3xl font-bold text-white text-glow">
            GDSC
          </h1>
        </div>

        {/* Tree and deer images */}
        ...
        >
          ...
          <Link
            ref={buttonRef}
            to="/registrationcard"
            className="relative px-6 sm:px-8 py-3 sm:py-4 text-white font-semibold text-sm sm:text-lg rounded-lg shadow-xl transform transition-all duration-300 hover:scale-110 hover:shadow-lg hover:text-cyan-200 flex items-center justify-center"
            style={{
